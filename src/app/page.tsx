		...
		<>
			<MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
				<div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
					<p className="text-sm font-semibold text-gray-700">
						read<span className="text-blue-600">smart</span>
					</p>
				</div>
				<h1 className="max-w-4cl text-5xl font-bold md:text-6xl lg:text-7xl">
			...
			<div>
				<div className="relative isolate">
					...
					<div>
						<div className="m-auto max-w-6xl px-6 lg:px-8">
							<div className="mt-16 flow-root sm:mt-24">
								<div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
									<Image
										...
										alt="product preview"
										quality={100}
										className="rounded-md bg-white p-2 sm:p-8 mdLp-20 shadow-2xl ring-1 ring-gray-900/10"
									/>
								</div>
							</div>
						</div>
			...
			<div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
				<div className="mb-12 px-6 lg:px-8">
					<div className="mx-auto max-w-2xl sm:text-center">
						...
						<p className="mt-4 text-lg text-gray-600">
							Chatting to your PDF files has never been easier than whith
							read<span className="text-blue-600">smart</span>
						</p>
					</div>
				</div>
				...
				<ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
					<li className="md:flex-1">
						<div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 p-4 md:border-t-2 md:pt-4">
					...
					<li className="md:flex-1">
						<div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 p-4 md:border-t-2  md:pt-4">
							...
							<span className="mt-2 text-zink-700">
								It&apos;s that simple. Try out ReadSmart today - it
